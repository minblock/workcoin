Workcoin Core version 0.16.3 is now available from:

  <https://download.work.provigen.net/workcoin-0.16.3/>
...
Workcoin Core versions 0.14.0 up to 0.16.2. It is recommended to upgrade any of
