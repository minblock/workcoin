...
([`valgrind.supp`](https://github.com/workcoin-project/workcoin/blob/master/contrib/valgrind.supp))
...
- ThreadRPCServer : Remote procedure call handler, listens on port 1032 for connections and services them.
