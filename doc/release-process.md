...
space *do not upload these to the work.provigen.net server, nor put them in the torrent*.
...
- Upload zips and installers, as well as `SHA256SUMS.asc` from last step, to the work.provigen.net server.

```
- Update work.provigen.net version
...
- Announce the release:
  ...
  - blog.work.provigen.net blog post
