...
* Update manpages, see [gen-manpages.sh](https://github.com/workcoin-project/workcoin/blob/master/contrib/devtools/README.md#gen-manpagessh).
...
Check out the source code in the following directory hierarchy.
    ...
    git clone https://github.com/workcoin-project/workcoin.git
...
By default, Gitian will fetch source files as needed. To cache them ahead of time, make sure you have checked out the tag you want to build in workcoin, then:
...
### Build and sign Workcoin Core for Linux, Windows, and macOS:

    export GITIAN_THREADS=2
    export GITIAN_MEMORY=3000
    
    pushd ./gitian-builder
    ./bin/gbuild --num-make $GITIAN_THREADS --memory $GITIAN_MEMORY --commit workcoin=v${VERSION} ../workcoin/contrib/gitian-descriptors/gitian-linux.yml
    ...
    ./bin/gbuild --num-make $GITIAN_THREADS --memory $GITIAN_MEMORY --commit workcoin=v${VERSION} ../workcoin/contrib/gitian-descriptors/gitian-win.yml
    ...
    ./bin/gbuild --num-make $GITIAN_THREADS --memory $GITIAN_MEMORY --commit workcoin=v${VERSION} ../workcoin/contrib/gitian-descriptors/gitian-osx.yml
...
Build output expected:
  ...
  4. macOS unsigned installer and dist tarball (`workcoin-${VERSION}-osx-unsigned.dmg`, `workcoin-${VERSION}-osx64.tar.gz`)
  5. Gitian signatures (in `gitian.sigs.ltc/${VERSION}-<linux|{win,osx}-unsigned>/(your Gitian key)/`)

### Verify other gitian builders signatures to your own. (Optional)

Add other gitian builders keys to your gpg keyring, and/or refresh keys: See `../workcoin/contrib/gitian-keys/README.md`.
...
Codesigner only: Sign the macOS binary:
    ...
    transfer workcoin-osx-unsigned.tar.gz to macOS for signing
...
- Detached signatures will then be committed to the [workcoin-detached-sigs](https://github.com/workcoin-project/workcoin-detached-sigs) repository, which can be combined with the unsigned apps to create signed binaries.
...
- Upload zips and installers, as well as `SHA256SUMS.asc` from last step, to the workcoin.org server.
...
- Announce the release:
  ...
  - Create a [new GitHub release](https://github.com/workcoin-project/workcoin/releases/new) with a link to the archived release notes.
