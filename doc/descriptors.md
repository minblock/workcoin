# Support for Output Descriptors in Workcoin Core

Since Workcoin Core v0.17, there is support for Output Descriptors. This is a
...
on Workcoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Workcoin Core wallets, a convenience function `combo` is
