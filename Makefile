...
pkgdatadir = $(datadir)/workcoin
pkgincludedir = $(includedir)/workcoin
pkglibdir = $(libdir)/workcoin
pkglibexecdir = $(libexecdir)/workcoin
...
ACLOCAL = ${SHELL} /workcoin/build-aux/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
AUTOCONF = ${SHELL} /workcoin/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /workcoin/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /workcoin/build-aux/missing automake-1.15
AWK = mawk
BDB_CFLAGS = 
BDB_CPPFLAGS = 
BDB_LIBS = -ldb_cxx-4.8
BITCOIN_CLI_NAME = workcoin-cli
BITCOIN_DAEMON_NAME = workcoind
BITCOIN_GUI_NAME = workcoin-qt
BITCOIN_TX_NAME = workcoin-tx
...
COPYRIGHT_HOLDERS_FINAL = The Workcoin Core developers
COPYRIGHT_HOLDERS_SUBSTITUTION = Workcoin Core
COPYRIGHT_YEAR = 2017
CPP = gcc -E
...
MAINT = 
MAKEINFO = ${SHELL} /workcoin/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
...
OTOOL64 = 
PACKAGE = workcoin
PACKAGE_BUGREPORT = https://github.com/workcoin-project/workcoin/issues
PACKAGE_NAME = Workcoin Core
PACKAGE_STRING = Workcoin Core 0.14.2
PACKAGE_TARNAME = workcoin
PACKAGE_URL = https://workcoin.org/
...
ZMQ_CFLAGS = 
ZMQ_LIBS = -lzmq
abs_builddir = /workcoin
abs_srcdir = /workcoin
abs_top_builddir = /workcoin
abs_top_srcdir = /workcoin
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /workcoin/build-aux/install-sh
...
OSX_APP_BUILT = $(OSX_APP)/Contents/PkgInfo $(OSX_APP)/Contents/Resources/empty.lproj \
  ...
  $(OSX_APP)/Contents/MacOS/Workcoin-Qt $(OSX_APP)/Contents/Resources/Base.lproj/InfoPlist.strings
...
$(OSX_APP)/Contents/MacOS/Workcoin-Qt: $(BITCOIN_QT_BIN)
	$(MKDIR_P) $(@D)
...
$(APP_DIST_EXTRAS): $(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/Workcoin-Qt
...
$(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/Workcoin-Qt: $(OSX_APP_BUILT) $(OSX_PACKAGING)
