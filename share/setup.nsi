...
!else
InstallDir $PROGRAMFILES\Workcoin
!endif
CRCCheck on
XPStyle on
BrandingText " "
...
VIAddVersionKey ProductName "Workcoin Core"
...
Section -post SEC0001
    ...
    CreateShortcut "$SMPROGRAMS\$StartMenuGroup\$(^Name).lnk" $INSTDIR\workcoin-qt
    CreateShortcut "$SMPROGRAMS\$StartMenuGroup\Workcoin Core (testnet, -bit).lnk" "$INSTDIR\workcoin-qt" "-testnet" "$INSTDIR\workcoin-qt" 1
    ...
    WriteRegStr HKCR "workcoin" "URL Protocol" ""
    WriteRegStr HKCR "workcoin" "" "URL:Workcoin"
    WriteRegStr HKCR "workcoin\DefaultIcon" "" $INSTDIR\workcoin-qt
    WriteRegStr HKCR "workcoin\shell\open\command" "" '"$INSTDIR\workcoin-qt" "%1"'
SectionEnd
...
Section /o -un.Main UNSEC0000
    Delete /REBOOTOK $INSTDIR\workcoin-qt
...
Section -un.post UNSEC0001
    ...
    Delete /REBOOTOK "$SMPROGRAMS\$StartMenuGroup\Workcoin Core (testnet, -bit).lnk"
    Delete /REBOOTOK "$SMSTARTUP\Workcoin.lnk"
