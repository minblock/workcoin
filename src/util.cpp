...
const char * const BITCOIN_CONF_FILENAME = "workcoin.conf";
const char * const BITCOIN_PID_FILENAME = "workcoind.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "WorkCoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/WorkCoin";
#else
    // Unix
    return pathRet / ".workcoin";
#endif
#endif
}
