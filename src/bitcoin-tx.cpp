...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " workcoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  workcoin-tx [options] <hex-tx> [commands]  Update hex-encoded workcoin transaction\n" +
            "or:     workcoin-tx [options] -create [commands]   Create hex-encoded workcoin transaction\n" +
            "\n";
