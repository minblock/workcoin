...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s workcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  workcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded workcoin transaction") + "\n" +
              "  workcoin-tx [options] -create [commands]   " + _("Create hex-encoded workcoin transaction") + "\n" +
              "\n";
