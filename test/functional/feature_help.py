...
"""Verify that starting workcoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start workcoin with -h for help text")
        ...
        self.log.info("Start workcoin with -version for version information")
        ...
        self.log.info("Start workcoind with -fakearg to make sure it does not start")
